    ...
    <div className="h-svh flex flex-col">
      ...
      <div className="flex-grow grid grid-cols-12 items-center overflow-hidden">
        <div className="col-span-5 pl-8">
          <div>
            <ProjectImagesSlide imgs={project?.images} />
          </div>
        </div>
        <div className="col-span-7 pl-8 overflow-y-scroll max-h-svh">
          <div className="my-30">
            ...
            <p className="text-2xl">
              ...
              repellendus consectetur vitae veritatis debitis est! Eaque dolorem
              accusamus magni illo deserunt beatae, praesentium quis? Lorem
              ipsum dolor sit amet, consectetur adipisicing elit. Quidem modi
              maxime reprehenderit molestiae ea eveniet, minus unde porro
              ...
              aperiam, corporis ratione aliquam! Praesentium, explicabo maxime?
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quia
              harum iste, eos nemo quas sit! Incidunt hic, aspernatur fugiat
              maiores accusamus totam odit dolore iusto doloremque et magnam
              iste sit? Lorem ipsum dolor sit amet consectetur, adipisicing
